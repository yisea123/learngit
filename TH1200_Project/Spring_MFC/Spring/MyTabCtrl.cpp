...
void CMyTabCtrl::CreateButton(LPCTSTR sCaption, int nID, int iTab, UINT uLocation, int iX, int iY, int iLen, int iHeight)
{
	CRect rc;
	GetClientRect(&rc);//GetWindowRect
	int x = rc.left + MARGIN_LEFT;
...
double CMyTabCtrl::GetItemTextAsDouble(int nID)
{
	CString s;
	GetDlgItem(nID)->GetWindowText(s);
