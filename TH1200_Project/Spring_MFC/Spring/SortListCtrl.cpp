...
{
	const int iYear1 = _wtoi( strDate1.Mid( 0, 4 ) );
	const int iYear2 = _wtoi( strDate2.Mid( 0, 4 ) );
	...
	const int iMonth1 = _wtoi( strDate1.Mid( 5, 2 ) );
	const int iMonth2 = _wtoi( strDate2.Mid( 5, 2 ) );
	...
	const int iDay1 = _wtoi( strDate1.Mid( 8, 2 ) );
	const int iDay2 = _wtoi( strDate2.Mid( 8, 2 ) );
