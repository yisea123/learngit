...
public:
	...
	void CreateButton(LPCTSTR sCaption, int nID, int iTab, UINT uLocation = 0, int iX = 0, int iY = 0, int iLen = 50, int iHeight=8);
	void CreateEdit(LPCTSTR sCaption, int nID, int iTab, UINT uLocation = 0, int iX = 0, int iY = 0, int iLen = 45);
	...
	double GetItemTextAsDouble(int nID);
